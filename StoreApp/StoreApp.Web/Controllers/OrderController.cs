...
public class OrderController : Controller
{
    ...
    private Payment ProcessPayment(OrderModel model)
    {
        ...
        options.ApiKey = "sandbox-gsNoW3W0Hg15BZdxcj4JvM4vPCyP1LHu";
        options.SecretKey = "sandbox-90OkverNzycnGzfquaIai3pCQHhiN7Ny";
        ...
        paymentCard.ExpireYear = model?.Year;
        ...
        buyer.Email = "gorkemkayas@hotmail.com";
        ...
        shippingAddress.ContactName = "Görkem Kaya";
        ...
        billingAddress.ContactName = "Görkem Kaya";
